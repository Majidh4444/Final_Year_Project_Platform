...
def main():
    ...
    if selected_model == 'Home':
        st.title('SUSTAINABLE WATER MANAGEMENT')
        st.image('./assets/yacht.jpg')
        st.success('Sustainable water management is a project that addresses the issue of growing underwater waste in oceans and '
