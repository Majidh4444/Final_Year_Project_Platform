...
import pandas as pd
test_df = pd.read_csv('D:\\Majidh\\Amrita\\Academics\\Sem 8\\Website\\test_data\\test_df')
...
def app2():
    ...
    model = load_model(
        'D:\\Majidh\\Amrita\\Academics\\Sem 8\\Website\\models\\Water_Potability\\xgboost_without_source_month.pkl')
